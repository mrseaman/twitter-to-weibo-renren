...
def sync_twitter(account):
    ...
    wbclient = APIClient(app_key="fake", app_secret='fake', redirect_uri='fake')
    wbclient.set_access_token(account.wb_access_token, '9999') #set weibo access token
    
    rrclient = renren.APIClient(app_key='fake', app_secret='fake', redirect_uri='fake')
    rrclient.set_access_token(account.rr_access_token)
